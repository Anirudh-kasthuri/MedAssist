...
const rawSource = role === 'doctor' && technicalAnalysis
? technicalAnalysis
: summary;
...
```
  ...
  <div className="pl-6 pr-6 py-3 bg-zinc-50 dark:bg-zinc-950/30 border-t border-zinc-100 dark:border-zinc-800 flex items-start space-x-3">
    ...
    <p className="text-[10px] text-zinc-400 leading-tight">
      <span className="font-bold">Automated Triage:</span> This analysis is generated by AI for informational purposes only. It does not constitute a definitive medical diagnosis.
    </p>
  </div>
